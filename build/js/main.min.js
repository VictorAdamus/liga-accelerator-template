...
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  Object(_utils_accordion__WEBPACK_IMPORTED_MODULE_4__["accordion"])();
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function open() {
      ...
      var inputModalName = modal.querySelector('[data-input-name="focus"]');
...
var fun = function fun() {
  var accordionButtons = document.querySelectorAll('[data-footer-title]');
  if (accordionButtons) {
...
var buttonElement = document.querySelector('[data-about-btn]');
var showText = function showText() {
  var textElement = document.querySelector('[data-about-text]');
...
var extraTextHandler = function extraTextHandler() {
  return buttonElement.addEventListener('click', showText);
};
...
var maskForTel = function maskForTel() {
  ...
  for (var i = 0; i < inputTelList.length; i++) {
    var mask = Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(inputTelList[i], maskOptions);
  }
};
