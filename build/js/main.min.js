...
/* harmony import */ var _utils_scroll_to_form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/scroll-to-form */ "./js/utils/scroll-to-form.js");
/* harmony import */ var _utils_mask_for_tel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/mask-for-tel */ "./js/utils/mask-for-tel.js");
/* harmony import */ var _utils_accordion__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/accordion */ "./js/utils/accordion.js");
/* harmony import */ var _utils_extraTextHandler__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/extraTextHandler */ "./js/utils/extraTextHandler.js");
...
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  Object(_utils_accordion__WEBPACK_IMPORTED_MODULE_4__["checkResizeWindow"])();
  // window.addEventListener('resize', checkResizeWindow());
  Object(_utils_mask_for_tel__WEBPACK_IMPORTED_MODULE_3__["maskForTel"])();
  Object(_utils_extraTextHandler__WEBPACK_IMPORTED_MODULE_5__["extraTextHandler"])();
  Object(_utils_scroll_to_form__WEBPACK_IMPORTED_MODULE_2__["scrollToFeedback"])();
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function open() {
      ...
      var inputModalName = modal.querySelector('[data-input-name]');
...
/*!*******************************!*\
  !*** ./js/utils/accordion.js ***!
  \*******************************/
/*! exports provided: checkResizeWindow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkResizeWindow", function() { return checkResizeWindow; });
// список-аккордион
var accordionButtons = document.querySelectorAll('.footer__title');
var footerMenu = document.querySelector('.footer__menu');
var footerContacts = document.querySelector('.footer__contacts');
var showAccordionList = function showAccordionList() {
...
var checkResizeWindow = function checkResizeWindow() {
...
/***/ "./js/utils/extraTextHandler.js":
/*!**************************************!*\
  !*** ./js/utils/extraTextHandler.js ***!
  \**************************************/
/*! exports provided: extraTextHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "extraTextHandler", function() { return extraTextHandler; });
// показать дополнительный текст
var extraTextMobile = document.querySelector('.about--extra-mobile');
var extraTextDesktop = document.querySelector('.about--extra-desktop');
var extraTextButton = document.querySelector('.btn--detailed');
...
var extraTextHandler = function extraTextHandler() {
...
/***/ "./js/utils/mask-for-tel.js":
/*!**********************************!*\
  !*** ./js/utils/mask-for-tel.js ***!
  \**********************************/
/*! exports provided: maskForTel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "maskForTel", function() { return maskForTel; });
// маска для номера телефона в форме обратной связи
var maskForTel = function maskForTel() {
  var inputTelList = document.querySelectorAll('[data-input-name="tel"]');
  var maskOptions = {
    mask: '+{7}(000)000-00-00'
  };
  for (var i = 0; i < inputTelList.length; i++) {
    var mask = IMask(inputTelList[i], maskOptions);
  }
};
...
var scrollToFeedback = function scrollToFeedback() {
  var scrollToFormBtn = document.querySelector('[data-scroll-form]');
