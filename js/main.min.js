...
/* harmony import */ var _utils_extraTextHandler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/extraTextHandler */ "./js/utils/extraTextHandler.js");
/* harmony import */ var _utils_form_checked__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/form-checked */ "./js/utils/form-checked.js");
...
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  Object(_utils_form_checked__WEBPACK_IMPORTED_MODULE_4__["formChecked"])();
  Object(_utils_extraTextHandler__WEBPACK_IMPORTED_MODULE_3__["showText"])();
...
var showText = function showText() {
  var buttonText = document.querySelector('[data-about-btn]');
  var text = document.querySelector('[data-about-text]');
  var textTablet = document.querySelector('[data-text-tablet]');
  var textMobile = document.querySelector('[data-text-mobile]');
...
/***/ "./js/utils/form-checked.js":
/*!**********************************!*\
  !*** ./js/utils/form-checked.js ***!
  \**********************************/
/*! exports provided: formChecked */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formChecked", function() { return formChecked; });
var formChecked = function formChecked() {
  var submitButtonIndex = document.querySelector('[data-submit-index]');
  var inputNameIndex = document.querySelector('[data-index-name]');
  var inputPhoneIndex = document.querySelector('[data-index-phone]');
  var submitButtonModal = document.querySelector('[data-submit-modal]');
  var inputNameModal = document.querySelector('[data-modal-name]');
  var inputPhoneModal = document.querySelector('[data-modal-phone]');
  submitButtonIndex.addEventListener('click', function (e) {
    ...
    } else if (inputPhoneIndex.value.length < 16) {
      e.preventDefault();
  ...
  submitButtonModal.addEventListener('click', function (e) {
    ...
    } else if (inputPhoneModal.value.length < 16) {
      e.preventDefault();
